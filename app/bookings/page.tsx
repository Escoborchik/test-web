...
export default function BookingsPage() {
  ...
  const bookings = useAppSelector((state) => state.bookingsManagment.bookings);
  ...
  const filteredBookings = useMemo(() => {
    return bookings.filter((booking) => {
      const matchesCourt =
        selectedCourtId === "all" || booking.courtId === selectedCourtId;
  ...
  const confirmedBookings = useMemo(
    () => filteredBookings.filter((booking) => booking.status === "confirmed"),
    [filteredBookings]
  );
  ...
  const rejectBooking = () => {
    dispatch(updateStatusBooking({ id: actionBooking.id, status: "rejected" }));
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="repeat">Абонемент</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            ...
            <Card>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {pendingBookings.map((booking) => {
                      const court =
                        courts.find((item) => item.id === booking.courtId) ??
                        null;
              ...
              <div className="flex items-center justify-between p-3 border-t border-border">
                <p className="text-sm text-muted-foreground">
                  Показано 1-
                  {Math.min(itemsPerPage, pendingBookings.length)} из{" "}
                  {pendingBookings.length}
                </p>
                <div className="flex gap-2">
                  <Button
                  ...
                  <Button
                    ...
                    size="sm"
                    disabled={
                      currentPage * itemsPerPage >= pendingBookings.length
                    }
                  >
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {actionBooking?.firstName} {actionBooking?.lastName}? Клиент
              получит уведомление.
            </DialogDescription>
          </DialogHeader>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {actionBooking?.firstName} {actionBooking?.lastName}? Это действие
              нельзя отменить.
            </DialogDescription>
          </DialogHeader>
          <div className="flex gap-3 justify-end mt-4">
