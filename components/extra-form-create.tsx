...
interface ExtraFormCreateProps {
	onAdd: (extraData: Extra) => void;
	onCancel: () => void;
}

export const ExtraFormCreate = ({ onAdd, onCancel }: ExtraFormCreateProps) => {
				...
				<div className="space-y-2">
					...
					>
						...
						<SelectContent>
							...
							<SelectItem value="extra">₽/услуга</SelectItem>
						</SelectContent>
					</Select>
				</div>
